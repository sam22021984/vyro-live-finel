...
const MODULE_MAP = [
  // CONNECTED
  { module:"VIP Membership",    status:"connected",   tables:["vip_tiers","vip_benefits","vip_rewards","vip_profiles"],             page:"/vip-membership",   notes:"Full live read from vip_tiers; all 11 tiers dynamic" },
  { module:"Me / Profile VIP",  status:"connected",   tables:["vip_tiers","vip_profiles"],                                          page:"/me",               notes:"MeVIPSection reads vip_tiers live" },
  { module:"Profile Statistics",status:"connected",   tables:["user_xp","user_gifting_stats","coin_wallets"],                        page:"/me",               notes:"MeStats reads user_xp, gifting_stats, coin_wallets + UserProfile" },
  { module:"Social Stats Bar",  status:"connected",   tables:["user_wallets"],                                                       page:"/me",               notes:"Following/Followers/Friends/Visitors from UserProfile + Supabase" },
  { module:"Level Cards",       status:"connected",   tables:["user_xp","stream_levels"],                                           page:"/me",               notes:"MeLevelCards reads user_xp for all 4 level types" },
  { module:"Top Fans",          status:"connected",   tables:["leaderboard","user_gifting_stats"],                                  page:"/me",               notes:"MeTopFans reads leaderboard; falls back to gifting_stats" },
  { module:"Finance / Wallet",  status:"connected",   tables:["coin_wallets","user_wallets","coin_reward_transactions"],            page:"/finance",          notes:"Live balances + transaction history; polls every 20s" },
  { module:"Daily Checkin",     status:"connected",   tables:["daily_bonus"],                                                       page:"/tasks-rewards",    notes:"Reads streak from daily_bonus; writes on claim" },
  { module:"Daily Tasks",       status:"connected",   tables:["daily_tasks","reward_claims"],                                       page:"/tasks-rewards",    notes:"Reads daily_tasks; writes to reward_claims on claim" },
  { module:"Leaderboard",       status:"connected",   tables:["leaderboard","reward_leaderboards"],                                 page:"/profile-stats",    notes:"Live leaderboard by category+period; polls every 30s" },
  { module:"Support Tickets",   status:"connected",   tables:["support_tickets"],                                                   page:"/support",          notes:"Create + read tickets live from Supabase" },
  { module:"Social Friends",    status:"connected",   tables:["social_friends"],                                                    page:"/me",               notes:"MeSocial reads confirmed friend count from social_friends" },

  // PARTIALLY CONNECTED
  { module:"Live Streams",      status:"partial",     tables:["live_streams","live_users","stream_profiles","stream_levels"],       page:"/live-room",        notes:"Room UI complete; stream create/end not yet persisted" },
  ...
  { module:"Family System",     status:"partial",     tables:["families"],                                                          page:"/social",           notes:"Family UI built; not reading families table" },

  // DISCONNECTED
  { module:"User Presence",     status:"disconnected",tables:["user_presence"],                                                     page:"/me",               notes:"Online status hardcoded; user_presence unused" },
  { module:"Gift System",       status:"disconnected",tables:["gift_catalog","room_gifts","user_gifting_stats"],                    page:"/live-room",        notes:"Gifts animated locally; gift_catalog not read" },
  ...
  { module:"Messaging / Chat",  status:"disconnected",tables:["muted_chats","call_sessions"],                                       page:"/inbox",            notes:"Chat uses Base44 entities; Supabase tables empty" },
  ...
  { module:"KYC / Security",    status:"disconnected",tables:["kyc_requests","security_events"],                                    page:"/support",          notes:"No KYC flow connected" },
  { module:"Commissions",       status:"disconnected",tables:["commissions"],                                                        page:"/agency-dashboard", notes:"Agency commissions static" },
  { module:"Revenue / Finance", status:"disconnected",tables:["finance_dashboard","revenue_summary"],                               page:"/owner-dashboard",  notes:"Owner dashboard hardcoded" },
  { module:"Seat Requests",     status:"disconnected",tables:["seat_requests","room_moderation"],                                   page:"/live-room",        notes:"Seat UI not persisted to Supabase" },
  ...
  { module:"Admin KPIs",        status:"disconnected",tables:["admin_kpis","owner_dashboard_stats_vw"],                             page:"/owner-dashboard",  notes:"All dashboards hardcoded" },
  { module:"Room Likes",        status:"disconnected",tables:["room_likes"],                                                        page:"/live-room",        notes:"Like button not synced to Supabase" },
];
