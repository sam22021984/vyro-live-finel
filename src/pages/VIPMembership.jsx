...
/* ─────────────── DATA ─────────────── */
const VIP_LEVELS = [
  { id:"vip1",    level:"VIP 1",           icon:"🛡️", price_coins:100000,    price_cash:"$10",    color:"#60A5FA", gradient:"linear-gradient(135deg,#93C5FD,#3B82F6,#1E40AF)", glow:"rgba(59,130,246,0.5)",   stone:"Crystal Shield",  tier:1,
    design:["Silver Crown","Crystal Center Stone","Blue Glow Effect","Premium Metal Frame"],
    benefits:["VIP Badge","Silver Profile Frame","Name Color Effect","Basic VIP Entry Animation"] },
  { id:"vvip",    level:"VVIP",            icon:"👑", price_coins:300000,    price_cash:"$28",    color:"#FCD34D", gradient:"linear-gradient(135deg,#FDE68A,#F59E0B,#D97706)", glow:"rgba(245,158,11,0.5)",   stone:"Golden Crystal Crown", tier:2,
    design:["Gold Crown","Emerald Stone","Luxury Glow"],
    benefits:["Golden VIP Badge","Premium Frame","Chat Effect","VIP Support"] },
  { id:"svip",    level:"SVIP",            icon:"💎", price_coins:800000,    price_cash:"$70",    color:"#38BDF8", gradient:"linear-gradient(135deg,#7DD3FC,#0EA5E9,#0369A1)", glow:"rgba(14,165,233,0.5)",   stone:"Royal Sapphire Crown", tier:3,
    design:["Blue Sapphire Crystal","Golden Crown","Diamond Particles"],
    benefits:["Sapphire VIP Badge","Premium Entrance Effect","Exclusive Gifts","VIP Events Access"] },
  { id:"ssvip",   level:"SSVIP",           icon:"🏆", price_coins:1200000,   price_cash:"$105",   color:"#E2E8F0", gradient:"linear-gradient(135deg,#F1F5F9,#CBD5E1,#64748B)", glow:"rgba(203,213,225,0.5)",  stone:"Imperial Diamond Shield", tier:4,
    design:["Platinum Shield","Large Diamond","Golden Wings"],
    benefits:["Imperial Badge","Diamond Frame","VIP Lounge Access","Premium Rewards"] },
  { id:"msvip",   level:"MSVIP",           icon:"🔥", price_coins:1500000,   price_cash:"$130",   color:"#F97316", gradient:"linear-gradient(135deg,#FED7AA,#F97316,#C2410C)", glow:"rgba(249,115,22,0.5)",   stone:"Master Royal Crown", tier:5,
    design:["Black Gold Crown","Ruby Stone","Luxury Fire Effect"],
    benefits:["Master VIP Badge","Premium Profile Design","Exclusive Gifts","Ranking Boost"] },
  { id:"mssvip",  level:"MSSVIP",          icon:"🦅", price_coins:2000000,   price_cash:"$170",   color:"#C084FC", gradient:"linear-gradient(135deg,#E9D5FF,#A855F7,#7E22CE)", glow:"rgba(168,85,247,0.5)",   stone:"Royal Phoenix Crown", tier:6,
    design:["Phoenix Wings","Purple Crystal","Fire Animation"],
    benefits:["Phoenix Badge","Special Frame","VIP Rewards","Elite Access"] },
  { id:"misvip",  level:"MISVIP",          icon:"⚜️", price_coins:3000000,   price_cash:"$250",   color:"#FFC83D", gradient:"linear-gradient(135deg,#FEF3C7,#FFC83D,#92400E)", glow:"rgba(255,200,61,0.55)",  stone:"Imperial Emperor Badge", tier:7,
    design:["Emperor Crown","Platinum Gold Style","Royal Energy Effect"],
    benefits:["Imperial Frame","Royal Entry Effect","Premium Gifts","Priority Support"] },
  { id:"missvip", level:"MISSVIP",         icon:"💠", price_coins:6000000,   price_cash:"$500",   color:"#818CF8", gradient:"linear-gradient(135deg,#C7D2FE,#6366F1,#3730A3)", glow:"rgba(99,102,241,0.55)",  stone:"Ultimate Diamond King", tier:8,
    design:["Purple Royal Crystal","Diamond Crown","Platinum Wings"],
    benefits:["Ultimate VIP Badge","Luxury Profile Frame","VIP Lounge","Exclusive Rewards"] },
  { id:"ultra",   level:"ULTRA MISSVIP",   icon:"🐉", price_coins:10000000,  price_cash:"$850",   color:"#EF4444", gradient:"linear-gradient(135deg,#FCA5A5,#EF4444,#991B1B)", glow:"rgba(239,68,68,0.55)",   stone:"Royal Dragon Crown", tier:9,
    design:["Dragon Wings","Golden Crown","Red Ruby Effect"],
    benefits:["Dragon VIP Badge","Royal Frame","Ultra Rewards","Dedicated VIP Service"] },
  { id:"legend",  level:"LEGEND IMISVIP",  icon:"🌌", price_coins:25000000,  price_cash:"$2,100", color:"#A5F3FC", gradient:"linear-gradient(135deg,#CFFAFE,#06B6D4,#164E63)", glow:"rgba(6,182,212,0.55)",   stone:"Galaxy Legendary Crown", tier:10,
    design:["Cosmic Diamond","Galaxy Particles","Platinum Wings"],
    benefits:["Legendary Badge","Global VIP Identity","Legendary Gifts","VIP Ranking Priority"] },
  { id:"royal",   level:"ROYAL IMISSVIP",  icon:"🔱", price_coins:50000000,  price_cash:"$4,200", color:"#FFC83D", gradient:"linear-gradient(135deg,#FFC83D,#EF4444,#A855F7)", glow:"rgba(255,200,61,0.65)",  stone:"Royal Emperor Throne", tier:11, isMax:true,
    design:["Emperor Crown","Royal Throne Symbol","Red Diamond","Platinum Wings"],
    benefits:["Highest VIP Identity","Royal Badge","Royal Frame","Exclusive Royal Gifts","Elite VIP Lounge","Maximum VIP Privileges"] },
];
