...
const ROLES = [
  ...
  },
  {
    ...
    reviewsAt: "Country Manager Dashboard",
    afterApproval: ["Super Admin Access Granted"],
    workflow: ["Application", "Country Manager Dashboard"],
    formFields: [
      { key: "vyroId",    label: "VYRO ID",      placeholder: "e.g. VYRO-12345",          rows: 1 },
      { key: "hostId",    label: "Host ID",      placeholder: "Your approved Host ID",     rows: 1 },
  ...
  },
  {
    ...
    tag: "Executive",
    tagColor: "#0EA5E9",
    eligibility: "Apply to Country Manager Dashboard",
    dept: "Business",
  ...
  },
  {
    ...
    tag: "Open",
    tagColor: "#10B981",
    eligibility: "Apply to Business Manager Dashboard",
