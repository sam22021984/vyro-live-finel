        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: "#9CA3AF" }}>
              {current ? current.desc : "Guide · Rules · User · Host · Gifting · Streaming"}
            </div>
          </div>
        </div>
      </div>
        ...
        {!active ? (
          ...
          <motion.div key={active}
            ...
            {active === "guide"           ? <GuideScreen /> :
             active === "rules"           ? <LevelSystemRules onNavigate={nav} /> :
             active === "user_guide"      ? <UserLevelGuide onBack={nav} /> :
