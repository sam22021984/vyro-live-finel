      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
        {ACH.map((a, i) => (
          <motion.div key={a.label}
            ...
            <div style={{
              fontSize: 9, fontWeight: 800, marginTop: 5, lineHeight: 1.3,
              color: a.unlocked ? a.color : "#9CA3AF",
            }}>{a.label}</div>
            {a.unlocked && (
              <div style={{
                marginTop: 4, fontSize: 8, fontWeight: 800, color: "#22C55E",
                background: "rgba(34,197,94,0.1)", borderRadius: 8, padding: "1px 6px", display: "inline-block",
              }}>✓ Unlocked</div>
            )}
          </motion.div>
        ))}
