      ...
      {LEVELS.map((l, i) => (
        <motion.div key={l.label}
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ background: l.bg, borderRadius: 12, padding: "2px 8px", fontSize: 11, fontWeight: 900, color: l.color }}>
              Lv.{l.level}
            </div>
          </div>
          ...
          <div style={{ marginTop: 5, fontSize: 8, color: l.color, fontWeight: 700, background: `${l.color}0D`, borderRadius: 7, padding: "2px 6px", display: "inline-block" }}>
            {l.extra}
          </div>
        </motion.div>
      ))}
