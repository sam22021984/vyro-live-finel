...
const HOST_LEVELS = [
  { range: "LV1–LV10",    title: "Newcomer",               badge: "Bronze Mic",              icon: "⚙️", color: "#9E9E9E", tier: "Newcomer",    coins: 2_000_000,      benefits: ["Basic Host Badge","Public Room Access","Standard Chat","Basic Analytics"] },
  { range: "LV11–LV20",   title: "Beginner Host",          badge: "Bronze Stage",            icon: "🥉", color: "#CD7F32", tier: "Rising I",    coins: 5_000_000,      benefits: ["Bronze Host Badge","Audience Insights","Room Customization","Priority Support"] },
  { range: "LV21–LV30",   title: "Rising Host",            badge: "Silver Mic",              icon: "🥈", color: "#C0C0C0", tier: "Rising II",   coins: 10_000_000,     benefits: ["Silver Badge","Featured Discovery","Premium Room Effects","Advanced Analytics"] },
  { range: "LV31–LV40",   title: "Performer",              badge: "Gold Mic",                icon: "🥇", color: "#FFD700", tier: "Performer I", coins: 20_000_000,     benefits: ["Gold Host Badge","Homepage Discovery","VIP Room Features","Monthly Bonus"] },
  { range: "LV41–LV50",   title: "Popular Host",           badge: "Sapphire Stage",          icon: "💙", color: "#4169E1", tier: "Performer II",coins: 35_000_000,     benefits: ["Star Crown","Featured Placement","Premium Effects","Enhanced Revenue"] },
  { range: "LV51–LV60",   title: "Star Host",              badge: "Emerald Stage Crown",     icon: "💚", color: "#50C878", tier: "Star I",      coins: 60_000_000,     benefits: ["Super Star Badge","Priority Discovery","Royal Room Theme","VIP Support"] },
  { range: "LV61–LV70",   title: "Super Star",             badge: "Ruby Elite Crown",        icon: "❤️", color: "#E0115F", tier: "Star II",     coins: 100_000_000,    benefits: ["Elite Crown","Global Visibility","Luxury Room FX","Premium Revenue Boost"] },
  { range: "LV71–LV80",   title: "Elite Host",             badge: "Amethyst Crown",          icon: "💜", color: "#9B59B6", tier: "Elite I",     coins: 180_000_000,    benefits: ["Master Badge","Platform Highlight","Mythic Room Effects","Elite Support"] },
  { range: "LV81–LV90",   title: "Master Host",            badge: "Diamond Crown",           icon: "💎", color: "#B9F2FF", tier: "Elite II",    coins: 300_000_000,    benefits: ["Legend Crown","Global Featured","Dragon Room FX","Legendary Revenue"] },
  { range: "LV91–LV100",  title: "Legend Host",            badge: "Universe Crown",          icon: "👑", color: "#F59E0B", tier: "Legend",      coins: 500_000_000,    benefits: ["GOAT Crown","Universe Featured","Ultimate Room FX","Lifetime Recognition"] },
  { range: "LV101–LV120", title: "Champion Host",          badge: "Champion Crown",          icon: "🏆", color: "#F59E0B", tier: "Champion",    coins: 1_000_000_000,  benefits: ["Champion Crown","Discovery Boost","Event Access","VIP+ Support"] },
  { range: "LV121–LV140", title: "Mythic Host",            badge: "Mythic Stage Crown",      icon: "🌟", color: "#7C3AED", tier: "Mythic I",    coins: 2_000_000_000,  benefits: ["Mythic Badge","Mythic Aura","Global Highlight","Elite Event Access"] },
  { range: "LV141–LV160", title: "Legendary Host",         badge: "Dragon Crown",            icon: "🐉", color: "#DC2626", tier: "Mythic II",   coins: 4_000_000_000,  benefits: ["Legendary Dragon Crown","Dragon Stream FX","Global Prestige","Legendary Rewards"] },
